...
func (s *Suite) EthTests() []utesting.Test {
	return []utesting.Test{
		...
		{Name: "TestBlockHashAnnounce_66", Fn: s.TestBlockHashAnnounce_66},
...
func (s *Suite) TestBlockHashAnnounce(t *utesting.T) {
	fmt.Println("next block: ", s.chain.Len(), "chain head: ", s.chain.Head().Hash())
	...
	if err := recvConn.waitForBlock(nextBlock); err != nil {
		t.Fatal(err) // TODO fix err message
	}
}
